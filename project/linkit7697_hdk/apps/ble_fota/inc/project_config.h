...
#define APP_BLE_FOTA_DEVICE_NAME           "BLE_FOTA"
#define APP_BLE_FOTA_SERVICE_UUID          (0x18AA)
#define APP_BLE_FOTA_CHAR_UUID             (0x2BBB)

#define APP_BLE_FOTA_CHAR_VALUE_HANDLE     0x0016
